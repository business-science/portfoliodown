...
The goal of `portfoliodown` is to make is _painless for data scientists_ to create a polished personal website so they can host their project portfolios __(and get great job interviews)__.
