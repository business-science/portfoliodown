...
The `theme = "raditian"` (default) theme is an excellent choice if you are seeking a streamlined portfolio. The portfolio is designed to communicate your value in as few words as possible. However, the portfolio lacks color template customization that some of the other portfolio themes include. Overall, this is my top choice to get interviews fast. 
